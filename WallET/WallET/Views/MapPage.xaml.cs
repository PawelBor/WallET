...
namespace WallET.Views
{
    ...
    public sealed partial class MapPage : Page
    {
        ...
        private async void showStore_Tapped(object sender, TappedRoutedEventArgs e)
        {
            try
            {
            ...
            {
                MessageDialog tapShowStore = new MessageDialog("Connection has not been established, please check your connection.");
                await tapShowStore.ShowAsync();
            }
        }
